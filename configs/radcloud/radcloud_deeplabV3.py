...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img_path='radar', seg_map_path='lidar'),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(
...
work_dir = '../submodules/lib-avstack-core/third_party/mmsegmentation/work_dirs/RadcloudDataset-DeepLabV3plus'
